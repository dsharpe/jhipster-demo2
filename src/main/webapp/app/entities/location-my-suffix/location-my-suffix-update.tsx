    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="demoApp.location.home.createOrEditLabel">Create or edit a Location</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : locationEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvInput id="location-my-suffix-country" type="select" className="form-control" name="country.id">
                    <option value="" key="0" />
                    {countries

    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="demoApp.employee.home.createOrEditLabel">Create or edit a Employee</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : employeeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvInput id="employee-my-suffix-department" type="select" className="form-control" name="department.id">
                    <option value="" key="0" />
                    {departments
                ...
                <AvGroup>
                  ...
                  <AvInput id="employee-my-suffix-manager" type="select" className="form-control" name="manager.id">
                    <option value="" key="0" />
                    {employees

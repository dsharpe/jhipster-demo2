    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="demoApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvInput id="job-history-my-suffix-job" type="select" className="form-control" name="job.id">
                    <option value="" key="0" />
                    {jobs
                ...
                <AvGroup>
                  ...
                  <AvInput id="job-history-my-suffix-department" type="select" className="form-control" name="department.id">
                    <option value="" key="0" />
                    {departments
                ...
                <AvGroup>
                  ...
                  <AvInput id="job-history-my-suffix-employee" type="select" className="form-control" name="employee.id">
                    <option value="" key="0" />
                    {employees

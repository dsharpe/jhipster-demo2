              ...
              <tbody>
                {jobHistoryList.map((jobHistory, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{jobHistory.job ? <Link to={`job-my-suffix/${jobHistory.job.id}`}>{jobHistory.job.id}</Link> : ''}</td>
                    <td>
                      {jobHistory.department ? (
                        <Link to={`department-my-suffix/${jobHistory.department.id}`}>{jobHistory.department.id}</Link>
                      ) : (
                        ''
                      )}
                    </td>
                    <td>
                      {jobHistory.employee ? <Link to={`employee-my-suffix/${jobHistory.employee.id}`}>{jobHistory.employee.id}</Link> : ''}
                    </td>

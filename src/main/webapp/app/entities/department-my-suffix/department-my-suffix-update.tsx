    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="demoApp.department.home.createOrEditLabel">Create or edit a Department</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : departmentEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvInput id="department-my-suffix-location" type="select" className="form-control" name="location.id">
                    <option value="" key="0" />
                    {locations

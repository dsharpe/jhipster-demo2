              ...
              <tbody>
                {employeeList.map((employee, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      {employee.department ? (
                        <Link to={`department-my-suffix/${employee.department.id}`}>{employee.department.id}</Link>
                      ) : (
                        ''
                      )}
                    </td>
                    <td>{employee.manager ? <Link to={`employee-my-suffix/${employee.manager.id}`}>{employee.manager.id}</Link> : ''}</td>
